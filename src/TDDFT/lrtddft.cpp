    ...
    const Domain& dm)
{
...

  {
    ...
    SetValue(psiCol, 0.0);
    DblNumMat psiRow(ntotLocal, numStateTotal);                    // ave wavefun Row  
    SetValue(psiRow, 0.0);
